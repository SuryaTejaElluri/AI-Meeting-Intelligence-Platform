    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="glass-panel w-full max-w-md p-8 rounded-2xl border border-slate-800 shadow-2xl space-y-6 relative overflow-hidden">
        ...
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold font-heading text-white">Create New Account</h2>
          <p className="text-xs text-slate-400">Join the AI Meeting Intelligence Platform</p>
        </div>
        ...
        <button
          ...
          className="w-full py-3 px-4 rounded-xl font-medium text-xs bg-slate-900/90 border border-slate-700/80 text-slate-200 hover:bg-slate-800 hover:text-white transition-all flex items-center justify-center gap-3 shadow-md hover:shadow-purple-500/10 active:scale-[0.99]"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 px-4 rounded-xl font-semibold text-xs bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:opacity-95 shadow-lg shadow-purple-500/20 flex items-center justify-center gap-2"
          >
